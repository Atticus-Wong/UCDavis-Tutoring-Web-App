  ...
  return (
    ...
    <Box sx={{ 
      ...
      <Box sx={{ display: 'flex', justifyContent: {xs: 'center', sm: 'center', md: 'space-between'}, width: '100%', alignItems: 'center'}}>
        <Box textAlign={{xs: 'left', sm: 'center', md: 'left'}} sx={{ height: '100%' }}>
          ...
          <Typography variant="body1" marginBottom={{xs: '1rem', sm: '0.5rem'}} textAlign={{xs: 'left', sm: 'center', md: 'left'}} >Look forward to our Winter &apos;26 tutor recruitment!</Typography>
          {(isSm || isMd) && <BongoCat />}
          ...
          <Box  sx={{ display: 'flex', flexDirection: {xs: 'column', sm: 'column', md: 'row'}, alignItems: 'center', justifyContent: 'left', gap: '1rem', color: '#FFDE28' }}>
            <Link href="https://discord.com/invite/HXfwHbYF7f" target="_blank">
              <Button variant='outlined' sx={{ paddingY: '0.4rem', gap: 1, alignItems: 'center', borderColor: '#FFDE28', borderRadius: '8px', backgroundColor: '#242424', borderWidth: '0.1rem', fontFamily: 'Sunflower' }}>
                <Typography fontFamily='Sunflower' color='#FFDE28' fontWeight={2}>Discord</Typography>
                <Image src="Yellow_discord.svg" alt="logo" width={30} height={20}/>
              </Button>
            </Link>
            <Link href="https://www.instagram.com/cstutoringatucd/" target="_blank">
              <Button variant='outlined'sx={{ paddingY: '0.4rem', gap: 1, borderColor: '#FFDE28', borderRadius: '8px', backgroundColor: '#242424', borderWidth: '0.1rem', fontFamily: 'Sunflower' }}>
                <Typography fontFamily='Sunflower' color='#FFDE28' fontWeight={2}>Instagram</Typography>
                <Image src="Yellow_Instagram.svg" alt="logo" width={20} height={20}/>
              </Button>
            </Link>
            <Link href="https://linktr.ee/cstutoringatucd" target="_blank">
              <Button variant='outlined'sx={{ paddingY: '0.4rem', gap: 1, fontSize: '1rem', borderColor: '#FFDE28', borderRadius: '8px', backgroundColor: '#242424', borderWidth: '0.1rem', fontFamily: 'Sunflower'  }}>
                <Typography fontFamily='Sunflower' color='#FFDE28' fontWeight={2}>Linktree</Typography>
    ...
    <Box sx={{ 
      ...
      backgroundColor: "#242424",
        ...
        <Box paddingTop='2rem' paddingX={{xs: '1.5rem', sm: '2rem', md: '3.5rem'}} height='100%'>
            <Typography variant='h3' fontFamily='Hanuman'sx={{color: 'text.secondary' }}>Become a tutor for Winter &apos;26!</Typography>
            ...
            <Button 
              ...
              sx={{ 
                ...
                fontSize: {xs: '0.9rem', sm: '1.2rem', md: '1rem'}, 
                fontWeight: 1
              }}
            >
              See Details
    ...
    <Box
      sx={{
        ...
        <Typography variant='body1' marginTop="0.8rem" sx={{paddingRight: {md: 40}}}>CS Tutoring organizes undergraduate volunteer tutors to help students with undergraduate CS courses every quarter. 
                    We select our tutors carefully so we can give you the best tutoring experience!</Typography>
        <Typography variant="body1" marginTop="1rem" sx={{paddingRight: {md: 40}}}>We offer our upper and lower division tutoring services throughout the school year. And you can choose to meet up with your tutor in person or online.</Typography>
    </Box>
